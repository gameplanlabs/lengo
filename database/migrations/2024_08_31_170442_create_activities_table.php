    ...
    public function up(): void
    {
        Schema::create('activities', function (Blueprint $table) {
            ...
            $table->integer('estimated_time')->default(1)
                ->comment('Time in hours, allocated or estimated to complete the activity.');
            $table->integer('actual_time')->default(1)->comment('Time in hours');
            ...
            $table->foreignId('daily_target_id')->nullable()->constrained()->nullOnDelete();
