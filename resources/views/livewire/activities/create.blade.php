...
use App\Livewire\Forms\ActivityCreateForm;
use Livewire\Volt\Component;

new class extends Component {
    public ActivityCreateForm $form;
    ...
    public function create()
    {
        ...
        $this->redirectRoute('activities.index');
    }
}; ?>

<section class="w-full">
    <x-activities.layout heading="Create Activity" subheading="Start a new project.">
            ...
            <form wire:submit="create">
                <div class="space-y-6">
                    ...
                    <flux:input wire:model="form.title" id="title" label="{{ __('Title') }}" type="text"
                        name="title" required autofocus autocomplete="title" placeholder="Activity title" />

                    <flux:textarea rows="2" label="{{ __('Details') }}" wire:model="form.description" />

                    <flux:select label="Activity Status" size="sm" placeholder="Choose status...">
